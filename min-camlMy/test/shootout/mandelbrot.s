...
.beq_else.1084:
	...
	subu	$r4, $r3, $r4
	addi	$r5, $r0, 0
	bne	$r4, $r5, .beq_else.1085
	sll	$r2, $r2, 1
	sra	$r3, $r3, 1
	j	.mul_sub.461	! calldir-tail
.beq_else.1085:
	sll	$r4, $r2, 1
	sra	$r3, $r3, 1
	sw	$r2, -4($r29)
...
.mul.464:
	addi	$r4, $r0, 0
	bgt	$r4, $r3, .ble_else.1086
	j	.mul_sub.461	! calldir-tail
.ble_else.1086:
	subu	$r2, $r0, $r2
	subu	$r3, $r0, $r3
	j	.mul_sub.461	! calldir-tail
.div_binary_search.467:
	addu	$r6, $r4, $r5
	sra	$r6, $r6, 1
	sw	$r3, -4($r29)
	sw	$r6, -8($r29)
	...
	subu	$r3, $r5, $r4
	addi	$r6, $r0, 1
	bgt	$r3, $r6, .ble_else.1087
	addi	$r2, $r4, 0
	jr	$r31
.ble_else.1087:
	lw	$r3, -12($r29)
	bgt	$r3, $r2, .ble_else.1088
	bne	$r2, $r3, .beq_else.1089
	lw	$r2, -8($r29)
	jr	$r31
.beq_else.1089:
	lw	$r2, -4($r29)
	...
	j	.div_binary_search.467	! calldir-tail
.ble_else.1088:
	lw	$r2, -4($r29)
	lw	$r4, -8($r29)
	addi	$r27, $r3, 0	! g'_args
...
.print_int.479:
	...
	sw	$r31, -8($r29)	! calldir
	addi	$r29, $r29, -8	! calldir
	jal	.div_binary_search.467	! calldir
	addi	$r29, $r29, 8	! calldir
	lw	$r31, -8($r29)	! calldir
	lui	$r3, 1525
	ori	$r3, $r3, 57600
...
.ble_cont.1094:
	...
	lw	$r4, -32($r29)
	sw	$r2, -36($r29)
	bgt	$r4, $r3, .ble_else.1097
	addi	$r3, $r0, 0
	lw	$r5, -28($r29)
	bne	$r5, $r3, .beq_else.1099
	addi	$r2, $r0, 0
	j	.beq_cont.1100
.beq_else.1099:
	addi	$r3, $r4, 48
...
.ble_cont.1102:
	...
	lw	$r4, -56($r29)
	sw	$r2, -60($r29)
	bgt	$r4, $r3, .ble_else.1105
	addi	$r3, $r0, 0
	lw	$r5, -52($r29)
	bne	$r5, $r3, .beq_else.1107
	addi	$r2, $r0, 0
	j	.beq_cont.1108
.beq_else.1107:
	addi	$r3, $r4, 48
...
.ble_cont.1106:
	...
	lw	$r4, -68($r29)
	sw	$r2, -72($r29)
	bgt	$r4, $r3, .ble_else.1109
	addi	$r3, $r0, 0
	lw	$r5, -64($r29)
	bne	$r5, $r3, .beq_else.1111
	addi	$r2, $r0, 0
	j	.beq_cont.1112
.beq_else.1111:
	addi	$r3, $r4, 48
...
.ble_cont.1110:
	...
	lw	$r4, -80($r29)
	sw	$r2, -84($r29)
	bgt	$r4, $r3, .ble_else.1113
	addi	$r3, $r0, 0
	lw	$r5, -76($r29)
	bne	$r5, $r3, .beq_else.1115
	addi	$r2, $r0, 0
	j	.beq_cont.1116
.beq_else.1115:
	addi	$r3, $r4, 48
...
.ble_cont.1114:
	...
	lw	$r4, -92($r29)
	sw	$r2, -96($r29)
	bgt	$r4, $r3, .ble_else.1117
	addi	$r3, $r0, 0
	lw	$r5, -88($r29)
	bne	$r5, $r3, .beq_else.1119
	addi	$r2, $r0, 0
	j	.beq_cont.1120
.beq_else.1119:
	addi	$r3, $r4, 48
...
.beq_else.1121:
	...
	addi	$r2, $r2, -1
	lwcl	$f8, -4($r29)
	j	.iloop.502	! calldir-tail
.bclt_else.1122:
	addi	$r2, $r0, 0
	j	.print_int.479	! calldir-tail
.xloop.491:
	addi	$r4, $r0, 400
	bgt	$r2, $r4, .ble_else.1123
	sw	$r2, -4($r29)
	sw	$r3, -8($r29)
	sw	$r31, -12($r29)	! calldir
	addi	$r29, $r29, -12	! calldir
	...
	sw	$r31, -24($r29)	! calldir
	addi	$r29, $r29, -24	! calldir
	jal	.iloop.502	! calldir
	addi	$r29, $r29, 24	! calldir
	lw	$r31, -24($r29)	! calldir
	lw	$r2, -4($r29)
	addi	$r2, $r2, 1
	lw	$r3, -8($r29)
	j	.xloop.491	! calldir-tail
.ble_else.1123:
	j	.print_newline.483	! calldir-tail
.yloop.487:
	addi	$r3, $r0, 400
	bgt	$r2, $r3, .ble_else.1124
	addi	$r3, $r0, 0
	sw	$r2, -4($r29)
	addi	$r27, $r3, 0	! g'_args
	addi	$r3, $r2, 0	! g'_args
	...
	sw	$r31, -8($r29)	! calldir
	addi	$r29, $r29, -8	! calldir
	jal	.xloop.491	! calldir
	addi	$r29, $r29, 8	! calldir
	lw	$r31, -8($r29)	! calldir
	lw	$r2, -4($r29)
	addi	$r2, $r2, 1
	j	.yloop.487	! calldir-tail
.ble_else.1124:
	jr	$r31
.min_caml_start:
...
!	div.s	$f2, $f2, $f3		! $f2 = (y *. y -. x) /. (2.0 *. y)
	sw	$r31, -4($r29)	
	jal	.min_caml_myfinv_forSQRT	! f3 = 1.0 / f3
	lw	$r31, -4($r29)	
...
! * finv
! # (Int32.to_int(Int32.bits_of_float 0.0001)) land 0x0000ffff ;;
! - : int = 46871
! # (Int32.to_int(Int32.bits_of_float 0.0001)) lsr 16;;
! - : int = 14545
!# (Int32.to_int (Int32.bits_of_float 0.001)) land 0x0000ffff;;	こっちで良さそう
!- : int = 4719
!# (Int32.to_int (Int32.bits_of_float 0.001)) lsr 16;;
!- : int = 14979
.min_caml_myfinv:		! 引数: $f0(a)	使うレジスタ(r3, f11 〜 f14)
	addi	$r3, $r0, 15
...
!sqrtから呼び出しやすくした	
.min_caml_myfinv_forSQRT:		! 引数: $f3(a)	使うレジスタ(r3, f11 〜 f14)
	addi	$r3, $r0, 15
	lfh	$f11, 16384	! $f11 = 2.0 定数
	lfl	$f11, 0		
	lfh	$f12, 14979	! $f12 初期値x 0.0001
