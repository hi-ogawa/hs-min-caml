...
let rec print_bool b =
  if b then (print_char 116; print_char 114; print_char 117; print_char 101)
  else (print_char 102; print_char 97; print_char 108; print_char 115; print_char 101)
in
(* let rec print_float f = *)	(* print_floatやりたい *)
(*   if  *)
